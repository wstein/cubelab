...
cubie-state cycles, ACube positional states, or an algorithm. The 3×3 output cards also
offer SSE and unfolded ACube positional spellings; each is directly pasteable into Setup.
