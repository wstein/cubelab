...
Invert, Simplify, all-size structural factoring, opt-in 3×3 regrip optimization/expansion, and Practice scramble actions. State-format input disables algebraic
